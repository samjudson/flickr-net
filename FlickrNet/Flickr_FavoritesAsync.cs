...
namespace FlickrNet
{
    public partial class Flickr
    {
        ...
        {
            FavoritesGetListAsync(null, 0, 0, callback);
        }
        ...
        {
            FavoritesGetListAsync(null, page, perPage, callback);
        }
        ...
        {
            FavoritesGetListAsync(userId, 0, 0, callback);
        }
        ...
        /// <param name="page">The page to download this time.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(string userId, int page, int perPage, Action<FlickrResult<PhotoCollection>> callback)
        {
