...
namespace FlickrNet
{
    ...
    public sealed class PhotoInfo : IFlickrParsable
    {
        ...
        {
            get { return UtilityMethods.BuddyIcon(OwnerIconServer, OwnerIconFarm, OwnerUserId); }
        }
        ...
        /// <summary>
        /// Weither the date taken is known or not.
        /// </summary>
            ...
            while (reader.MoveToNextAttribute())
            {
                switch (reader.LocalName)
                {
                    ...
                    case "isfavorite":
                        ...
                        break;
                    case "license":
                        License = (LicenseType) int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "views":
                        ViewCount = int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "rotation":
                        Rotation = int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "media":
        ...
        private void ParsePermissions(XmlReader reader)
        {
            while (reader.MoveToNextAttribute())
            {
                ...
                {
                    case "permcomment":
                        PermissionComment = (PermissionComment) int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "permaddmeta":
                        PermissionAddMeta = (PermissionAddMeta) int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    default:
                        UtilityMethods.CheckParsingException(reader);
                        break;
            ...
            while (reader.MoveToNextAttribute())
            {
                switch (reader.LocalName)
                {
                    ...
                    case "takengranularity":
                        DateTakenGranularity = (DateGranularity) int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "takenunknown":
            ...
            while (reader.MoveToNextAttribute())
            {
                switch (reader.LocalName)
                {
                    ...
                    case "x":
                        ...
                        break;
                    case "y":
                        YPosition = int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "w":
                        Width = int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    case "h":
                        Height = int.Parse(reader.Value, NumberFormatInfo.InvariantInfo);
                        break;
                    default:
                        UtilityMethods.CheckParsingException(reader);
                        break;
