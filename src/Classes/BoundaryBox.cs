...
namespace FlickrNet
{
    ...
    public class BoundaryBox
    {
        ...
        /// <param name="accuracy">The <see cref="GeoAccuracy"/> of the search parameter.</param>
        public BoundaryBox(double minimumLongitude, double minimumLatitude, double maximumLongitude,
                           double maximumLatitude, GeoAccuracy accuracy)
        ...
        {
            return String.Format(NumberFormatInfo.InvariantInfo, "{0},{1},{2},{3}", MinimumLongitude, MinimumLatitude,
        ...
        private double DiagonalDistance()
        {
            ...
            double e =
                Math.Acos((Math.Sin(latRad1)*Math.Sin(latRad2)) +
                          (Math.Cos(latRad1)*Math.Cos(latRad2)*Math.Cos(lonRad2 - lonRad1)));
            return e;
        }
    }
}