...
namespace FlickrNet45.Tests
{
    ...
    public class GroupsDiscussTests : BaseTest
    {
        ...
        {
            var topics = AuthInstance.GroupsDiscussTopicsGetList(Data.GroupId, 1, 10);
        ...
        {
            var groupId = Data.FlickrNetTestGroupId;
        ...
        public void GroupsDiscussTopicsGetListTest()
        {
            ...
            Assert.AreEqual(Data.GroupId, topics.GroupId, "GroupId should be the same.");
            Assert.AreNotEqual(0, topics.Count, "Should be more than one topics return.");
