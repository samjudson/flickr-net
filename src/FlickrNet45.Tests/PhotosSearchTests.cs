...
namespace FlickrNet45.Tests
{
    ...
    public class PhotosSearchTests : BaseTest
    {
        ...
        {
            PhotoSearchOptions o = new PhotoSearchOptions { UserId = Data.UserId };
        ...
        [Test]
        [ExpectedException(typeof(FlickrNet.Exceptions.InvalidApiKeyException))]
        ...
        [Test, Ignore("This method doesn't seem to work at the moment.")]
        public void PhotosSearchGalleryPhotos()
        {
            var o = new PhotoSearchOptions { UserId = Data.UserId, InGallery = true, Tags = "art" };
            var photos = Instance.PhotosSearch(o);
        ...
        public void PhotosSearchContactsPhotos()
        {
            ...
            Assert.IsNotNull(photos, "PhotosSearch should not return a null instance.");
            Assert.IsTrue(photos.Any(), "PhotoSearch should have returned some photos.");
            Assert.IsTrue(photos.All(p => p.UserId != Data.UserId), "None of the photos should be mine.");
